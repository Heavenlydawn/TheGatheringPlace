...
const Header = () => {
  ...
  return (
    <header className="flex gp-dark text-white items-center justify-around py-4 relative">
      ...
      <button
        className="md:hidden flex items-center px-3 py-2 border rounded text-white border-white w-12 h-12"
        onClick={toggleMenu}
      >
        <svg
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 left-0 w-64 h-full bg-dark text-white transform ${
